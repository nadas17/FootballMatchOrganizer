        ...
        <div className="glass-card p-6 mb-8 rounded-2xl">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center shadow-glow">
            ...
            <button 
              onClick={handleLogout}
              className="glass-button px-6 py-3 rounded-xl font-semibold transition-smooth hover:bg-red-500/20 hover:border-red-400/50"
            >
            ...
            {profile && !editing ? (
              <>
                ...
                <button 
                  ...
                  className="w-full glass-button-primary py-4 rounded-xl font-semibold transition-smooth"
                >
              ...
              <div className="glass-card p-12 text-center rounded-2xl">
                <div className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-glow">
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              {editing && (
                <button 
                  ...
                  className="w-full mt-6 glass-button py-3 rounded-xl font-semibold transition-smooth"
                >
                  <svg className="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
